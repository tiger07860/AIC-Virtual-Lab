...
####  Constants  ###############################################################
def graph(vin = 5,farads = 10,ohms=50,sim_time = 3):
    vin = vin           # Voltage in
    ...
    ohms = ohms*1000      # Resistance in ohms of the primary resistor. This connects
                        # the input voltage to pins 6 & 7 as well as the capacitor.
    
    sim_time = sim_time        # Length of time to run the entire simulation (in seconds)
